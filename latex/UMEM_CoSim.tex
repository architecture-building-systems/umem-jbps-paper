...
For cooling, a more dramatic discrepancy can be seen between co-simulation and solo EnergyPlus. A 20.2\% decrease in predicted cooling energy is observed.
...
When focusing on solely on EnergyPlus, a 7.5\% decrease in cooling energy is observed.
...
A 2.8\% increase in heating energy is observed.
...
When focusing on solely on CitySim, a X\% decrease in cooling energy is observed.
...
A 30.8\% decrease in heating energy is observed.
