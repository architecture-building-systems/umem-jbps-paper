...
\begin{abstract}
    ...
    show that coupling of EnergyPlus with CitySim resulted in a -20\% and
    -7.5\% impact on cooling consumption and a +2.8\% and +4.8\% impact on
...
simulated. An appropriate balance between the effort of implementation and value
...
predicted cooling energy, as seen in Figure
...
The results from this scenario are less extreme on the heating side and more
...
sentence to start of paragraph} Applied with essential functions for the
...
that the HPI and theoretical case studies due to the number and proximity of
surrounding buildings is not as large. \noteCM{I'm planning to elaborate on
these sections
...
Energy Modeling (UMEM) project. The authors would also like to acknowledge
