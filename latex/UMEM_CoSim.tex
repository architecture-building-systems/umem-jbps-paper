...
When focusing on solely on EnergyPlus, a 7.5\% decrease in cooling energy is observed, as seen in Figure \ref{fig:qn_eplus_cosimvssolo_cooling}. A 2.8\% increase in heating energy is observed, as seen in Figure \ref{fig:qn_eplus_cosimvssolo_heating}. These differences are less
...
\subsection{CitySim co-simulation results}\noteCM{Jerome -- I really need some help interpreting this...}
